# 🛒 cart01: Learning Rust Step-by-Step

**Goal:** Understand core Rust concepts through a simple `Product` struct with validation, tests, and error handling.

**Learning Outcomes:**
- - Struct definition and methods (ownership, borrowing)
- - Result<T, E> and error handling patterns
- - Testing with 100% code coverage
- - Rust traits (Display, Clone, Serialize)
- - DateTime and date parsing
...
## - Full Project Files (path + verbatim content)
...
help:
    @echo "$(BLUE)🛒 cart01: Learning Rust - E-Commerce Product Structure$(NC)"
    @echo ""
...
test:
    ...
    @echo "  ✓ Error cases       - Zero ID, empty name, negative price, invalid date"
...
## 🖨️ Generate PDF Book (README → PDF)
...
## 🆘 Common Rust Errors (and how to read them)
